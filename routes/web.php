...
Route::get('/tickets/delete/{ticket}', [TicketController::class, 'delete'])->name('tickets.delete'); //delete ticket in database
Route::get('/tickets/{ticket}', [TicketController::class, 'show'])->name('tickets.show');
Route::post('/tickets/{ticket}', [TicketController::class, 'update'])->name('tickets.update'); //jadi
